        ...
        if (src != null) {
            try {
                ...
                if (src.getFeatureList() != null && !src.getFeatureList().isEmpty()) {
                    ...
                    Query feat = em.createQuery("delete from FeatureEntity e where e.featureId=:featureId");
                ...
                if (src.getDatasetList() != null && !src.getDatasetList().isEmpty()) {
                    ...
                    Query dset = em.createQuery("delete from DatasetEntity e where e.datasetId=:datasetId");
                ...
                if (src.getOptionList() != null && !src.getOptionList().isEmpty()) {
                    ...
                    Query opt = em.createQuery("delete from OptionEntity e where e.optionId=:optionId");

                    Query pref = em.createQuery("delete from PreferenceEntity e where e.option.optionId=:optionId");
