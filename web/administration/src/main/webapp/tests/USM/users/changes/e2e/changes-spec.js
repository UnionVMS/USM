...
var UsersPage = require('../../account/page/usersPage');
var PoliciesPage = require('../../../policies/page/policiesPage');
var ChangesPage = require('../page/changesPage');
...
describe('User Changes page', function () {
    ...
    it('Test 1 - should test changes approve', function () {
		...
		*/
		...
		var resumeChange = function () {
            ...
            loginPage.visit();
            loginPage.login(userPendingChange, 'password',"MARE Quota User - (no scope)");
            ...
            changesPage.setUpdateContactDetailsEmail("email@mail.eu");
