var changesPage = function () {
    ...
    this.updateContactDetailsEmail= element.all(by.model('myContactDetails.email'));
    ...
    this.setUpdateContactDetailsEmail = function (value) {
        this.updateContactDetailsEmail.clear();
        this.updateContactDetailsEmail.sendKeys(value);
    };
