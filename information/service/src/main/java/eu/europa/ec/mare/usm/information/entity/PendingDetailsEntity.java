...
@NamedQueries({
        @NamedQuery(name = "PendingDetailsEntity.findByPendingDetailsId", query = "SELECT p FROM PendingDetailsEntity p WHERE p.pendingDetailsId = :pendingDetailsId"),
        @NamedQuery(name = "PendingDetailsEntity.findByUserName", query = "SELECT p FROM PendingDetailsEntity p WHERE p.userName = :userName"),
        @NamedQuery(name = "PendingDetailsEntity.findAll", query = "Select p from PendingDetailsEntity p")})
