var MenuPage = function () {
    ...
    this.userHome = element.all(by.css('.navbar-nav .dropdown'));
    ...
    this.userLogin = element(by.css('.navbar-nav .dropdown .dropdown-menu'));
...
//this.changePassword = this.userDropDown.element(by.linkText("Change Password"));
    ...
    this.clickUserLogin = function () {
        browser.wait(EC.elementToBeClickable(this.userLogin), 10000);
