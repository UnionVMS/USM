...
public class NotificationBuilder {
     ...
     */
    public static Notification buildReminder(String email, String userName, Date passwordExpiry) {
        LOGGER.debug("buildReminder(" + email + ", " + userName + ", " + passwordExpiry + ") - (ENTER)");
        ...
        String content = MessageFormat.format(prop.getProperty("reminder.content"), userName, expiryDate);
