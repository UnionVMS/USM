...
public class RoleServiceBean implements RoleService {
    ...
    public ComprehensiveRole createRole(ServiceRequest<ComprehensiveRole> request)
        ...
        try {
            auditLog = AuditLogMapper.mapToAuditLog(USMApplication.USM.name(), AuditOperationEnum.CREATE.getValue(), AuditObjectTypeEnum.ROLE.getValue() + " " + request.getBody().getName(), request.getBody().getDescription(), request.getRequester());
    ...
    public void updateRole(ServiceRequest<ComprehensiveRole> request)
        ...
        String auditLog = null;
        try {
            auditLog = AuditLogMapper.mapToAuditLog(USMApplication.USM.name(), AuditOperationEnum.UPDATE.getValue(), AuditObjectTypeEnum.ROLE.getValue() + " " + request.getBody().getName(), request.getBody().getDescription(), request.getRequester());
        } catch (AuditModelMarshallException e) {
            throw new RuntimeException(e.getMessage(), e);
        }
        auditProducer.sendModuleMessage(auditLog);
    ...
    public void deleteRole(ServiceRequest<Long> request)
        ...
        String auditLog = null;
        try {
            auditLog = AuditLogMapper.mapToAuditLog(USMApplication.USM.name(), AuditOperationEnum.DELETE.getValue(), AuditObjectTypeEnum.ROLE.getValue() + " " + request.getBody(), "" + request.getBody(), request.getRequester());
        } catch (AuditModelMarshallException e) {
            throw new RuntimeException(e.getMessage(), e);
        }
        auditProducer.sendModuleMessage(auditLog);
