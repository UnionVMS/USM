...
public class OrganisationRestClient {
    ...
    public <T> T getOrganisationNames(Class<T> responseType, ServiceRequest<OrganisationQuery> request)
    ...
    public <T> T getOrganisationParentNames(Class<T> responseType, ServiceRequest<Long> request)
            throws UniformInterfaceException {
        WebResource resource = webResource;
    ...
    public <T> T getNationNames(Class<T> responseType, ServiceRequest<OrganisationQuery> request)
            throws UniformInterfaceException {
        WebResource resource = webResource;
    ...
    public <T> T findOrganisations(Class<T> responseType, ServiceRequest<FindOrganisationsQuery> request)
            throws UniformInterfaceException {
        WebResource resource = webResource;
