...
public class LDAP {
    ...
    private String getValue(Attributes attrs, String attrId) throws NamingException {
        String ret = "";
    ...
    private void cleanUp(DirContext ldapContext, NamingEnumeration<SearchResult> answer) {
        if (answer != null) {
            try {
                answer.close();
            } catch (NamingException e) {
