...
public class RoleRestClient {
    ...
    public <T> T getRoleNames(Class<T> responseType, ServiceRequest<RoleQuery> request)
    ...
    public <T> T findRoles(Class<T> responseType, ServiceRequest<FindRolesQuery> request)
            throws UniformInterfaceException {
    ...
    public <T> T getRole(Class<T> responseType, ServiceRequest<GetRoleQuery> request)
            throws UniformInterfaceException {
    ...
    public <T> T createRole(Class<T> responseType, ServiceRequest<ComprehensiveRole> request)
            throws UniformInterfaceException {
        WebResource resource = webResource;
        return resource.type(MediaType.APPLICATION_JSON).
    ...
    public <T> T updateRole(Class<T> responseType, ServiceRequest<ComprehensiveRole> request)
            throws UniformInterfaceException {
        WebResource resource = webResource;
        return resource.type(MediaType.APPLICATION_JSON).
    ...
    public <T> T getFeatureGroupNames(Class<T> responseType, ServiceRequest<String> request)
            throws UniformInterfaceException {
        WebResource resource = webResource;
    ...
    public <T> T findPermissions(Class<T> responseType, ServiceRequest<FindPermissionsQuery> request)
            throws UniformInterfaceException {
    ...
    public <T> T getRoles(Class<T> responseType, ServiceRequest<RoleQuery> request) throws UniformInterfaceException {
        WebResource resource = webResource;
