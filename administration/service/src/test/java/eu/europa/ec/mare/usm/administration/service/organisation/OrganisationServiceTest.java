...
public class OrganisationServiceTest extends DeploymentFactory {
    ...
    @EJB
    private OrganisationService testSubject;
    ...
    public void testGetOrganisationNames() {
        ...
        assertNotNull("Expected Organisation Name '" + expected + "' not found in [" + response + "]",
    ...
    public void testGetOrganisationParentNames() {
        ...
        assertNotNull("Expected potential Parent Organisation Name '" + expected +
                "' not found in [" + response + "]", getFromList(response, expected));
    }
    ...
    public void testGetOrganisation() {
        // Set-up
        ServiceRequest<String> r1 = new ServiceRequest<>();
        ...
        // Execute
        ServiceRequest<Long> r2 = new ServiceRequest<>();
    ...
    public void testCreateOrganisation() {
        ...
        ServiceRequest<Long> r3 = new ServiceRequest<>();
        r3.setRequester("usm_admin");
        r3.setBody(organisation.getOrganisationId());
        Organisation response = testSubject.getOrganisation(r3);
        assertNotNull("Unexpected null result", response);
        assertEquals("Unexpected organisationName", request.getBody().getName(), response.getName());
    }
    ...
    public void testUpdateOrganisation() {
        ...
        Organisation setup = testSubject.getOrganisationByName(r1);
        ServiceRequest<Organisation> r2 = new ServiceRequest<>();
        r2.setRequester("usm_admin");
        r2.setBody(setup);
        if (setup == null) {
        ...
        // Verify
        ServiceRequest<String> r3 = new ServiceRequest<>();
    ...
    public void testCreateUpdateDeleteChannel() {
        ...
        ServiceRequest<Channel> newChannel = new ServiceRequest<>();
        ...
        assertEquals("Priority wasn't updated ", 2, (int) updatedChannel.getPriority());
        ...
        assertTrue("Channel wasn't deleted", ep.getChannelList() == null || ep.getChannelList().isEmpty());
    ...
    public void testAddRemoveContact() {
        ...
        ep = testSubject.getEndPoint(idRequest);
        assertTrue("contact wasn't deleted", ep.getPersons() == null || ep.getPersons().isEmpty());
    ...
    private ServiceRequest<EndPoint> createEndpointRequest(String organisation) {
        ServiceRequest<EndPoint> newEndPoint = new ServiceRequest<>();
