...
@NamedQueries({
        @NamedQuery(name = "ApplicationEntity.findByApplicationId", query = "SELECT a FROM ApplicationEntity a WHERE a.applicationId = :applicationId"),
        @NamedQuery(name = "ApplicationEntity.findByName", query = "SELECT a FROM ApplicationEntity a WHERE a.name = :name")})
