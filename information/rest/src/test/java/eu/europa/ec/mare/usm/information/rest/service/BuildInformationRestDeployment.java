...
public abstract class BuildInformationRestDeployment {
    ...
    public static Archive<?> createDeployment() {
        ...
        testWar.addPackages(true, "eu.europa.ec.mare.usm.information.rest");
    ...
    protected WebTarget getWebTargetExternal() {
        ...
        return client.target(EXTERNAL_TARGET_URL);
    }
    ...
    protected String getToken() {
        if (token == null) {
            token = jwtTokenHandler.createToken("user",
